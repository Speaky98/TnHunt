                        ...
                        <div class="card d-flex blur justify-content-center shadow-lg my-sm-0 my-sm-6 mt-8 mb-5">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg p-3">
                                    <h3 class="text-white text-primary mb-0">Dog Details</h3>
                                </div>
                            </div>
                            <div class="card-body">
                                <p class="pb-3">
                                    <img height="300px" class="w-100  border-radius-md shadow-lg" src="{{asset("/storage/images/chiens/" .$chien->image)}}" alt="image">
                                    ...
                                    <div class="card-body p-0 my-3">
                                        ...
                                        <div class="form-group mb-0 mt-md-0 mt-4">
                                            <div class=" mb-4">
                                                ...
                                                <h5 >{{$chien->description}}</h5>
                                            </div>
                                        </div>
                                        <div class="form-group mb-0 mt-md-0 mt-4">
                                            <div class=" mb-4">
                                                <label class="text-info">Prey</label>
                                                <h5 >{{$chien->animal->name}}</h5>
                                            </div>
                                        </div>
                                        <div class="row">
