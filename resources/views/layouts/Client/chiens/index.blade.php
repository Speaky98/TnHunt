        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center mx-auto my-auto">
                    <h1 class="text-white">Discover all dogs informations</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 text-start mb-5 mt-5">
                    ...
                    <p class="text-white opacity-8 mb-0">Here's where you find all dogs that you goes with their special breeds</p>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-12 mt-n5" > </br>
                                <a href="javascript:;" >
                                    <div  class="p-3 pe-md-0"  >
                                        <img class="w-75 border-radius-md shadow-lg" src="{{asset("/storage/images/chiens/" .$chien->image)}}" alt="image">
                                        <a href="{{ route('chiensFront.show', $chien->id) }}">
                            ...
                            <div class="col-lg-8 col-md-6 col-12 my-auto">
                                <div class="card-body ps-lg-0">
                                    ...
                                    <h5 class="mb-0"><span>Name : </span>{{$chien->name}}</h5>
                                    <h6 class="text-info"><span> Breed : </span>{{$chien->breed}}</h6>
                                    <p class="mb-0"><span>Prey : </span>{{$chien->animal->name}}</p>
                                </div>
                            </div>
                        </div>
